            ...
            switch (chon) 
            {
                ...
                case 5:
                {
                	...
                	for (int i=0;i<n;i++)
                	{
                		...
                		if (s==d)
                		{
                			System.out.println("Ban da chon tai khoan:" +d);
                			a[i].daoHan();
                		}
                		else
                		{
                            ...
                            for (int j = 0; j < n; j++) 
                            {
                                ...
                                if (c == f) 
                                {
                                    ...
                                    if (tienChuyen <= chuyen) 
                                    {
                                        ...
                                        System.out.println("Tai Khoan " + d + " Vua Chuyen: VND" + tienChuyen);
                                        System.out.println("Tai Khoan " + f + " Vua Nhan: VND" + tienChuyen);
                                    } 
                                    else 
                                    {
